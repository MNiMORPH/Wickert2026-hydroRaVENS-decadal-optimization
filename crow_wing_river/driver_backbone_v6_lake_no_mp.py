#!/usr/bin/env python3
"""
Backbone driver — Crow Wing v6 LAKE (no multipath) variant.

Differences from driver_backbone_v6_lake.py:
  - No multipath overrides (multipath is disabled at the config level by
    setting multipath_thresholds__mm beyond any reachable head).
  - 5 active params: PDD, et_scale, log τ_matrix (land), log recession_coeff_lake,
    log H_sill_lake.

Per-decade loop with min_obs filter. Returns mean score across qualifying decades.
"""
