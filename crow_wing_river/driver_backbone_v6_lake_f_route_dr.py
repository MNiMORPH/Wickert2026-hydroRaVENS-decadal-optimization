#!/usr/bin/env python3
"""
Backbone driver — Crow Wing v6 LAKE with f_route_lake AND direct_runoff_fraction
both as FREE calibrated parameters.

7 active params: PDD, et_scale, log τ_matrix (land), log recession_coeff_lake,
log H_sill_lake, f_route_lake (YAML-patched per eval), f_direct_runoff.

Multipath remains disabled at the config level. direct_runoff is enabled via
the MODULES dict.
"""
