#!/usr/bin/env python3
"""
Per-decade transient Dakota driver v2.0: 3-reservoir soil/shallow_till/deep_till (Blue Earth River).

Active params (4): log__recession_coeff_soil, f_exfiltration_soil, log__Hmax_soil, et_scale.
Fixed params: backbone (shallow_till+deep_till recession + snow/FGI + f_exfil_shallow_till),
              b_soil=2, H0 (chained from prior decade).
