#!/usr/bin/env python3
"""
Per-decade transient Dakota driver v1.0: 2-reservoir soil/till architecture (Blue Earth River).

Active params (4): log__recession_coeff_soil, f_exfiltration_soil, log__Hmax_soil, et_scale.
Fixed params: backbone (till recession + snow/FGI), b_soil=2, H0 (chained).
