...
Analog to extract_ftile_best.py for the v6.x architecture.
Scans each valid decade's runs/ directory for the most recent run whose
name contains DESC, reads its evaluations.dat, and reports the best
log__recession_coeff_soil and KGE.

Usage:
    python extract_ksoil_best.py --desc transient_v6.0 --save ksoil_v6.0.yml
"""
...
def main():
    ...
    parser.add_argument('--desc', default='transient_v6.0',
                        help='Substring that must appear in the run directory name')
    parser.add_argument('--save', default=None,
                        help='Write summary to this YAML file (e.g. ksoil_v6.0.yml)')
